...
set /p MYSQL_HOST_INPUT=MySQL host [localhost]: 
...
"DB_venv\Scripts\python.exe" scripts\mysql_setup.py --host "%MYSQL_HOST%" --port "%MYSQL_PORT%" --user "%MYSQL_USER%" --password "%MYSQL_PASSWORD%" --database "%MYSQL_DATABASE%"
if errorlevel 1 (
  echo.
